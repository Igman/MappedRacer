...
/**********************************************************
 * This class is used for managing the race by retrieving * data from the
...
public class RaceController extends HttpServlet {
	...
	/**
	 * This is the do get that will begin to create the json object representing
	 * the race id that was requested.
	 * 
	 * @param request
	 *            Contains the race's ID.
	 * @param response
	 ...
	 */
	private String getJSONCheckIn(int raceID) throws SelectException {
		...
		while (iterator.hasNext()) {
			...
			json.append("{userID:\"" + temp.getUserID() + "\", location:\""
					+ temp.getLocation() + "\", comment:\"" + temp.getComment()
					+ "\", picture:\"" + temp.getPic() + "\"},");
		}
	 ...
	 * @throws SQLException
	 */
	private String getJSONRacers(int raceID) throws SelectException {
	 ...
	 * @throws SQLException
	 */
	private String getJSONItems(int raceID) throws SelectException {
